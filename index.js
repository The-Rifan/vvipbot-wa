...
const BotName = 'THE_RIFAN BOT'; 
const instagram = 'The_Rifan'; 
const aktif = 'Kapan bot aktif';
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:RIFAN\n' // Nama kamu
            + 'ORG:THE_RIFAN;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=6289652898494:+62 896-5289-8494\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
...
*Selesaikan perintah untuk melakukan selanjutnya* ⚠️` ,MessageType.text, {quoted: m});
